...
[![Uma representação visual do `left_join` em que todas as linhas de x aparecem no resultado final, com mais informação junta de y. Fonte: @intror.](images/clipboard-1594422253.png){fig-align="center" width="424"}](https://r4ds.hadley.nz/joins#fig-join-left)
