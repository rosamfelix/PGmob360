...
![Exemplo de informação complementar de dados de Praças de Táxis (Cascais)](images/clipboard-279399363.png){alt="Exemplo de informação complementar de dados de Praças de Táxis (Cascais)" width="470"}
...
-   Durante quanto tempo serão publicados?
-   Qual é o compromisso com o publicador?
-   O que sabe sobre a exatidão dos dados?
-   Como são tratados os dados omissos?

Alguns dados abertos fornecem um [**API**](https://dados.gov.pt/pt/docapi/) (Application Programming Interface) para que se possa automaticamente chamar os dados mais atualizados disponíveis.
...
Tal permite inspirar outros utilizadores dos dados, bem como dar conhecimento à entidade que os partilhou trabalhos que podem ser realizados com esses dados - levando muitas vezes à descoberta de novas perspetivas sobre os dados.
...
Esta base de dados abertos é amplamente usada para definição de políticas públicas de segurança rodoviária, e na academia, com a elaboração de vários dashboards e estudos que utilizam os dados.
Exemplo:
...
Os dados incluem localização de origem e destino, data e hora, distância de viagem, tarifa, tipo de pagamento, e número de passageiros transportados.
