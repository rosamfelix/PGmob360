...
[Download R-4.4.1 para Windows](https://cran.r-project.org/bin/windows/base/R-4.4.1-win.exe) e correr o ficheiro executável.
...
[Download R-4.4.1 para MacOX](https://cran.r-project.org/).
...
[Download RStudio 2024.04](https://download1.rstudio.org/electron/windows/RStudio-2024.04.2-764.exe) e correr o ficheiro executável.

### MacOS

[Download RStudio 2024.04](https://download1.rstudio.org/electron/macos/RStudio-2024.04.2-764.dmg) e instale-o como habitualmente.
:::
...
Para utilizar o pacote `{r5r}` (versão v2.0 ou superior), é necessário ter o *Java Development Kit (JDK) 21* instalado no computador.
