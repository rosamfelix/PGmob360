...
É possível criar um mapa estático utilizando `plof(sf)`, mas também é possível criar mapas interactivos.
...
2.  [flows](https://raw.githubusercontent.com/rosamfelix/PGmob360/refs/heads/main/data/flows.csv)

Experimente copiar e colar, nos campos correspondentes, a informação sobre as viagens na área metropolitana de lisboa segundo o @IMOB.

[![Viagens totais na AML representadas interativamente no Flowmap.blue](images/clipboard-895240007.png)](https://www.flowmap.blue/in-browser)

::: callout-tip
## TPC

Experimente visualizar as viagems em transporte público na AML.
([flows_pt](https://raw.githubusercontent.com/rosamfelix/PGmob360/refs/heads/main/data/flows_tp.csv))
